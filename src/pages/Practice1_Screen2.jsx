...
function Practice1_Screen2({ setContextNotes }) {
  ...
  return (
    <article className="space-y-6">
      ...
      <HandbookDetails title="Подробнее: волатильность и риск потери капитала">
        <p>
          Волатильность измеряет разброс доходностей вокруг среднего, но не всегда совпадает с тем
          риском, который инвестор переживает психологически и экономически. Сильные колебания
          вверх тоже увеличивают волатильность, хотя сами по себе не являются убытком.
        </p>
        <p>
          Поэтому в практике риск часто уточняют: риск потери капитала, риск недостижения целевой
          доходности, риск нехватки ликвидности. Волатильность — важная, но не единственная
          теоретическая линза.
        </p>
      </HandbookDetails>
