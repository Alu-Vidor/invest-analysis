  ...
  return (
    <article className="space-y-6">
      ...
      <section className="grid items-start gap-4 lg:grid-cols-2">
        <IdeaCard title="Один аппарат, разные объекты">
          <p>
            Теоретически облигация, кредит, аренда и инвестиционный проект различаются
            экономическим содержанием, но математически сводятся к работе с потоком платежей и
            ставкой переноса во времени.
          </p>
        </IdeaCard>

        <IdeaCard title="Ставка — не просто число">
          <p>
            Ставка зависит от срока, валюты, риска и природы самого потока. Поэтому в серьезном
            анализе мы всегда уточняем, к какому объекту и какому горизонту она относится, а не
            подставляем одно абстрактное число во все формулы подряд.
          </p>
        </IdeaCard>
      </section>
