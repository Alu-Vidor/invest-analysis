...
function Practice2_Screen4({ setContextNotes }) {
  ...
  return (
    <article className="space-y-6">
      ...
      <IdeaCard title="Аннуитет и дифференцированный платеж">
        <p>
          Аннуитет держит общий платеж постоянным, а дифференцированный график обычно постепенно
          снижает платеж со временем, потому что основная сумма долга гасится равными долями.
        </p>
        <p className="mt-3">
          Теоретически это важно: одинаковый кредит можно структурировать по-разному, и форма
          графика меняет как комфорт заемщика, так и суммарную стоимость обслуживания долга.
        </p>
      </IdeaCard>
