...
function Practice1_Screen4({ setContextNotes }) {
  ...
  return (
    <article className="space-y-6">
      ...
      <HandbookDetails title="Подробнее: цена закрытия, adjusted close, дивиденды и сплиты">
        <p>
          Теоретически ценовой ряд не всегда однороден. Компания может выплачивать дивиденды или
          проводить сплит, и тогда сырое сравнение обычных цен закрытия искажает фактическую
          доходность инвестора.
        </p>
        <p>
          В прикладной работе для анализа полной доходности часто используют adjusted close. На
          вводном этапе мы сохраняем простую модель, но важно понимать, почему в профессиональных
          датасетах эта корректировка имеет значение.
        </p>
      </HandbookDetails>
