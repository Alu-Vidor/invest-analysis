...
function Practice2_Screen3({ setContextNotes }) {
  ...
  return (
    <article className="space-y-6">
      ...
      <IdeaCard title="Процентный риск">
        <p>
          Как только мы дисконтируем поток по рыночной ставке, появляется чувствительность цены к
          ее изменению. Если ставка растет, приведенная стоимость будущих платежей падает; если
          ставка снижается, цена потока растет.
        </p>
        <p className="mt-3">
          Особенно сильна эта реакция у далеких платежей. Это важная теоретическая интуиция,
          которая позже приведет нас к duration и другим мерам процентного риска.
        </p>
      </IdeaCard>
      ...
      <HandbookDetails title="Мостик к duration">
        <p>
          Если формулировать совсем коротко, duration помогает измерить, насколько чувствительна
          цена облигации к изменению ставки. Пока мы еще не вводим сам показатель, но уже видим его
          интуитивную основу: дальние платежи сильнее зависят от дисконтирования, чем ближние.
        </p>
      </HandbookDetails>
