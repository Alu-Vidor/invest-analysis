    ...
    <article className="space-y-6">
      ...
      <section className="grid gap-4 lg:grid-cols-[1.15fr_0.85fr]">
        <section className="content-block">
          ...
          <MathText
            as="p"
            text="Эта запись показывает состав задачи. Здесь I₀ обозначает первоначальные вложения, CFₜ — денежный поток в период t, r — цену капитала, σ — меру риска, L — ликвидность, T — инвестиционный горизонт."
            className="text-base leading-relaxed text-slate-700 dark:text-slate-200"
          />
        </section>

        <IdeaCard title="Почему этого нельзя избежать">
          <p>
