...
curve = pd.DataFrame(
    {
        ...
        "yield_pct": [3.64, 3.74, 3.75, 3.86, 4.26, 4.87],
    }
)
  ...
  return (
    <article className="space-y-6">
      <CourseHeader
        ...
        title="Временная стоимость денег"
        subtitle="Переходим от календаря платежей к их стоимости. Для примеров используем реальные доходности казначейских бумаг США на середину марта 2026 года как рыночную основу для дисконтирования."
      />
      ...
      <SourceNote>
        ...
        <strong>середину марта 2026 года</strong> по срокам от 1 до 30 лет. На их основе строим
      ...
      <HandbookDetails title="Подробнее: номинальная и реальная ставка">
        <p>
          Номинальная ставка учитывает денежный рост без явной поправки на инфляцию, а реальная —
          пытается показать, насколько меняется покупательная способность капитала. Если инфляция
          высока, номинально привлекательный результат может оказаться гораздо скромнее в реальном
          выражении.
        </p>
        <p>
          Для инвестиционного анализа это важно теоретически: сравнивать денежные потоки и ставки
          нужно в согласованной логике, не смешивая реальные и номинальные оценки.
        </p>
      </HandbookDetails>
